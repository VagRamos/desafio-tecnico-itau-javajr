...
import br.com.vagramos.transacao_api.business.services.EstatisticasService;
...
public class EstatisticasController {
    ...
    @GetMapping
    @Operation(description = "Endpoint responsável por consultar as estatísticas de transações")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Busca esfetuada com sucesso"),
